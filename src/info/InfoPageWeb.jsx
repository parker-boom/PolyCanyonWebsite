...
import GoogleMapsRoute from './GoogleMapsRoute.jsx';

// App screenshot
import appPreview from '../assets/generated/app/overview.webp';
    ...
    <>
      ...
      */}
        ...
        <Section>
          ...
          <NavigationButtons>
            <NavButton to="/about" $type="about">
              <NavButtonIcon $type="about">
                <FaBook />
              </NavButtonIcon>
              <NavButtonTitle $type="about">About</NavButtonTitle>
              <NavButtonSubtitle>The canyon’s story</NavButtonSubtitle>
            </NavButton>
      ...
      */}
        <Section>
          ...
          <img
            src={appPreview}
            alt="Poly Canyon app map and structure gallery"
            width="960"
            height="774"
            decoding="async"
            loading="lazy"
